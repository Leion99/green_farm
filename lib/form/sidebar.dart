          ...
          child: Align(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("Crop Details", style: TextStyle(fontSize: 22)),
                SizedBox(height: 10),
                /*Image.asset(
                  'images/wheat.jpg'
                ),*/
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: [
                      ...
                      Text("Home Page", style: TextStyle(fontSize: 24, color: Colors.white)),
